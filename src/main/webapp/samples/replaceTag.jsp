...
<body>
	<h1 class="samples">
		<a href="index.jsp">CKEditor Samples</a> &raquo; Replace Selected Textarea Element using JSP Tag
	</h1>
	<div class="description">
		<p>
			This sample shows how to replace selected
			<code>&lt;textarea&gt;</code>
			element with a CKEditor instance, <a href="http://link-to-docs">using Java code</a>.
		</p>
		<div>
		...
		<div id="moreText">
			...
			<pre class="samples">&lt;ckeditor:replace replace="textarea_id" basePath="../ckeditor/" /&gt;</pre>
			<p>
				Note that
				<code>
					<em>textarea_id</em>
