...
<body>
	<h1 class="samples">
	    <a href="index.jsp">CKEditor Samples</a> &raquo; Use the CKEditor <code>initialized</code> Property
	</h1>
	<div class="description">
		<p>
			The
			<code>initialized</code>
			property informs the editor that base parameters like the
		...
		<div id="moreText">
			<p>The most common usage scenario for this property is when you want to set base parameters manually and do not want the editor to
				duplicate them.</p>
			<p>
				Below are a few examples showing the usage of the
				<code>initialized</code>
				property:
			</p>
			<pre class="samples">
<span class="codeComment">// The "initialized" property used in the CKEditor for Java tag.</span>
&lt;script type="text/javascript"&gt; 
...
<span class="codeComment">// The "initialized" property used in the CKEditor for Java object.</span>
&lt;script type="text/javascript" src="../ckeditor/ckeditor.js"&gt;&lt;/script&gt;
&lt;%
...
<span class="codeComment">// Sample usage of the "ckeditor_initialized" attribute (with the c:set tag from the JSTL library).</span>
&lt;script type="text/javascript" src="../ckeditor/ckeditor.js"&gt;&lt;/script&gt;
...
