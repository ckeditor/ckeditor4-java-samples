...
<head>
<meta charset="utf-8">
<title>Replace Selected Textarea Element &mdash; CKEditor Sample</title>
...
<body>
	<h1 class="samples">
		<a href="index.jsp">CKEditor Samples</a> &raquo; Replace Selected Textarea Element using CKEditor Java Object
	</h1>
	<div class="description">
		<p>
			This sample shows how to replace selected
			<code>&lt;textarea&gt;</code>
			element with a CKEditor instance, <a href="http://link-to-docs">using Java code</a> and Expression Language (EL).
		</p>
		<div>
		...
		<div id="moreText">
			<p>
				To replace a
				<code>&lt;textarea&gt;</code>
				element, you need, first to set CKEditor Java Object as request attribute (using servlet class). Next you need to read this
				attribute with EL call placed on JSP at any point after the
				<code>&lt;textarea&gt;</code>
				element:
			</p>
			<pre class="samples">
...
&#x00024;{cke_instance}</pre>
			...
			<p>
				...
				constructors and methods, please refer to <a href="http://link-to-docs">online documentation</a>, <a
					href="http://link-to-java-docs">Java Docs</a> and check out the source code of this sample as well as the code of
				DispatchServlet.java file. <a id="showLess" href="javascript:SAMPLE_APP.showHide();">Show Less &#x025B4;</a>
			</p>
		</div>
	</div>
