...
<body>
	<h1 class="samples">
		<a href="index.jsp">CKEditor Samples</a> &raquo; Use CKEditor timestamp property
	</h1>
	<div class="description">
		<p>
			<a href="http://link-to-docs">Timestamp</a> is a random string of characters attached to URLs for resources loaded by the
			CKEditor, guaranteeing clean cache results when upgrading. End users will not have to go into browser's options to clear its
			cache after you have upgraded CKEditor on your server.
		</p>
		<p>
			To see hot it works please open Net tab in Firefox Firebug or Network tab Chrome DevTools and refresh page with
			<code>F5</code>
			. You will observe that main resources are loaded from server. If there was no timestamp, editor resources would be loaded from
			cache (You would see monits like "304 Not Modified" or "(from cache)").
		</p>
		<div>
...
<span class="codeComment">//Code used in DispatchServlet.java file</span>	
