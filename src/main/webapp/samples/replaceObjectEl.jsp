...
<body>
	...
	<div class="description">
		<p>
			...
			<code>&lt;textarea&gt;</code>
			element with a CKEditor instance <a href="http://link-to-docs">using the CKEditor for Java object</a>  and Expression Language (EL).
		</p>
		<div>
		...
		<div id="moreText">
			<p>
				To replace a
				<code>&lt;textarea&gt;</code>
				element with CKEditor, you need to start from setting the CKEditor for Java object as the request attribute using the servlet class.
				You then need to read this attribute with an EL call
				placed at any point after the
				<code>&lt;textarea&gt;</code>
				element on the JSP:
			</p>
			<pre class="samples">
...
&#x00024;{cke_instance}</pre>
			...
			<p>
				...
				constructors and methods, please refer to the <a href="http://link-to-docs">CKEditor for Java documentation</a> and the <a
					href="http://link-to-java-docs">API reference</a> or check the Java source code of this sample as well as the code of
					the <code>DispatchServlet.java</code> file in your IDE. <a id="showLess" href="javascript:SAMPLE_APP.showHide();">Show Less &#x025B4;</a>
			</p>
		</div>
	</div>
