...
<body>
	<h1 class="samples">
		<a href="index.jsp">CKEditor Samples</a> &raquo; Replace All Textarea Elements using CKEditor Java Object
	</h1>
	<div class="description">
		<p>
			This sample shows how to replace all
			<code>&lt;textarea&gt;</code>
			elements with CKEditor, <a href="http://link-to-docs">using Java code</a>.
		</p>
		<div>
