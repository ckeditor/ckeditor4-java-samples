...
/**
 * The {@code ConfigurationProvider} class provides custom configuration for CKEditor instances.
 */
public class ConfigurationProvider {
	...
	/**
	 * Returns a sample event that is applicable to all editor instances available on JSP.
	 * 
	 * @return the {@code GlobalEventHandler} object with an event for every editor instance on the JSP.
	 */
	...
	/**
	 * Returns a {@code Map} with attributes for the HTML {@code <textarea>} element that will be replaced by the editor.
	 * 
	 * @return a {@code Map} with attributes for the HTML {@code <textarea>} element.
	 */
