...
public class SubmitServlet extends HttpServlet {
	...
	protected void doPost( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
		...
		if ( requestPath.endsWith( EXTENSION ) ) {
			...
			request.setAttribute( "cke_submit_data", getAllFormFieldsAndValues( request ) );
	...
	/**
	 * Returns a {@code String} representing an HTML table with form fields and their values sent in the request.
	 * 
