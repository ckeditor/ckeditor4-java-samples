...
<body>
	<h1 class="samples">
		<a href="index.jsp">CKEditor Samples</a> &raquo; Replace All Textarea Elements with CKEditor Using a JSP Tag
	</h1>
	<div class="description">
		<p>
			This sample shows how to replace all
			<code>&lt;textarea&gt;</code>
			elements on the page with CKEditor <a href="http://link-to-docs">using Java code</a>.
		</p>
		<div>
		...
		<div id="moreText">
			...
			<pre class="samples">&lt;ckeditor:replaceAll basePath="../ckeditor/" /&gt;</pre>
			<p>
	...
	<ckeditor:replaceAll basePath="../ckeditor" config="${cke_config}" />
