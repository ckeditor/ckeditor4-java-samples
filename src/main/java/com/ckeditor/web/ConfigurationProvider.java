...
public class ConfigurationProvider {
     ...
     *
     * @return the {@code CKEditorConfig} object with custom editor
     * configuration.
     */
    ...
    /**
     * Returns a sample event that is applicable to all editor instances
     * available on JSP.
     *
     * @return the {@code GlobalEventHandler} object with an event for every
     * editor instance on the JSP.
     */
     ...
     *
     * @return the {@code EventHandler} object with an event for a single editor
     * instance.
     */
    ...
    /**
     * Returns a {@code Map} with attributes for the HTML {@code <textarea>}
     * element that will be replaced by the editor.
     *
     * @return a {@code Map} with attributes for the HTML {@code <textarea>}
     * element.
     */
    ...
    /**
     * Returns the initial value for a CKEditor instance.
     *
